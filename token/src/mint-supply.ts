...
//
// Всё считается в BigInt: суммы SPL — это u64 (до 1.8·10^19), что далеко за
// пределом безопасного целого в double, а разбор дробей через float копит
// ошибку округления. См. обоснование в config.ts.
//
// Жёсткие правила:
