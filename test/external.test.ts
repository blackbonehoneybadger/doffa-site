...
// Фиктивный mint: тест проверяет РАЗБОР ответа Jup, а не конкретный токен.
// Реальный адрес здесь только привязывал бы тест к деприкированному токену.
const DOFFA_MINT = "TestMint1111111111111111111111111111111111";
