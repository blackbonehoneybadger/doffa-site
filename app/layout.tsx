...
export const metadata: Metadata = {
  ...
  description:
    "COFFEE DOFFA — кофейня из Карачаево-Черкесии со своей игровой экономикой: тапай и копи зёрна, играй в DOFFA Defense, получай награду $DOFFA на Solana. Честный, прозрачный, халяльный проект.",
