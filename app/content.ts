  ...
  ru: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Входи в забег", d: "Зёрна — входной билет в забег DOFFA Bean Duel: волны врагов, движение, уклонение и способности." },
      ...
      claimNote: "Прошёл забег в DOFFA Bean Duel? Нажми «Забрать награду» в игре — $DOFFA закрепляется за твоим кошельком как заявка на вывод в сеть Solana.",
    ...
    roadmap: {
      ...
      phases: [
        { n: "Q3 2026", t: "Основание", d: "Выпуск $DOFFA на mainnet (100M, mint/freeze отозваны), игра DOFFA Bean Duel. Фонд наград на 1 000 000 $DOFFA утерян: доступ к кошельку потерян навсегда.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Как получить $DOFFA?", a: "Проходи забеги в DOFFA Bean Duel и нажимай «Забрать награду» — $DOFFA из Reward Vault закрепляется за твоим Solana-кошельком." },
  ...
  en: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Start a run", d: "Beans are your entry ticket to a DOFFA Bean Duel run — waves of enemies, movement, dodging and abilities." },
      ...
      claimNote: "Cleared a DOFFA Bean Duel run? Hit “Claim reward” in the game — $DOFFA is pinned to your wallet as a payout request to Solana.",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Foundation", d: "$DOFFA launch on mainnet (100M, mint/freeze revoked), the DOFFA Bean Duel game. The 1,000,000 $DOFFA Reward Vault is lost: access to the wallet is gone for good.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How do I get $DOFFA?", a: "Clear DOFFA Bean Duel runs and press “Claim reward” — $DOFFA from the Reward Vault is pinned to your Solana wallet." },
  ...
  ar: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "ابدأ الجولة", d: "الحبوب تذكرة دخولك إلى جولة DOFFA Bean Duel: موجات من الأعداء، حركة، مراوغة ومهارات." },
      ...
      claimNote: "اجتزت جولة DOFFA Bean Duel؟ اضغط «استلام المكافأة» في اللعبة — يُثبَّت $DOFFA على محفظتك كطلب سحب إلى سولانا.",
    ...
    roadmap: {
      ...
      title: "خارطة الطريق",
      phases: [
        { n: "Q3 2026", t: "التأسيس", d: "إطلاق $DOFFA على الشبكة الرئيسية (100M، صلاحيات mint/freeze ملغاة)، لعبة DOFFA Bean Duel. خزينة المكافآت البالغة 1,000,000 $DOFFA مفقودة: تعذّر الوصول إلى المحفظة نهائيًا.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "كيف أحصل على $DOFFA؟", a: "اجتز جولات DOFFA Bean Duel واضغط «استلام المكافأة» — $DOFFA من الخزينة تُثبَّت على محفظتك." },
  ...
  tr: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Koşuya başla", d: "Çekirdek, DOFFA Bean Duel koşusuna giriş biletidir: düşman dalgaları, hareket, kaçınma ve yetenekler." },
      ...
      claimNote: "DOFFA Bean Duel koşusunu mu bitirdin? Oyunda “Ödülü al”a bas — $DOFFA, Solana’ya ödeme talebi olarak cüzdanına sabitlenir.",
    ...
    roadmap: {
      ...
      title: "Yol haritası",
      phases: [
        { n: "Q3 2026", t: "Temel", d: "$DOFFA mainnet çıkışı (100M, mint/freeze iptal), DOFFA Bean Duel oyunu. 1.000.000 $DOFFA’lık Reward Vault kayboldu: cüzdana erişim kalıcı olarak yitirildi.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "$DOFFA nasıl alınır?", a: "DOFFA Bean Duel koşularını tamamla ve “Ödülü al”a bas — Reward Vault’tan $DOFFA cüzdanına sabitlenir." },
  ...
  es: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Empieza un run", d: "Los Granos son tu boleto de entrada a un run de DOFFA Bean Duel: oleadas de enemigos, movimiento, esquiva y habilidades." },
      ...
      claimNote: "¿Completaste un run de DOFFA Bean Duel? Pulsa «Reclamar recompensa» en el juego: $DOFFA se fija a tu billetera como solicitud de pago a Solana.",
    ...
    roadmap: {
      ...
      title: "Hoja de ruta",
      phases: [
        { n: "Q3 2026", t: "Fundación", d: "Lanzamiento de $DOFFA en mainnet (100M, mint/freeze revocados), el juego DOFFA Bean Duel. El Reward Vault de 1.000.000 $DOFFA está perdido: el acceso a la cartera se perdió para siempre.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Cómo consigo $DOFFA?", a: "Completa runs de DOFFA Bean Duel y pulsa «Reclamar recompensa»: $DOFFA del Reward Vault se fija a tu billetera Solana." },
  ...
  fr: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Lance un run", d: "Les Grains sont ton ticket d’entrée pour un run DOFFA Bean Duel : vagues d’ennemis, déplacement, esquive et compétences." },
      ...
      claimNote: "Run DOFFA Bean Duel terminé ? Appuie sur « Réclamer la récompense » dans le jeu : le $DOFFA est attaché à ton portefeuille comme demande de paiement vers Solana.",
    ...
    roadmap: {
      ...
      phases: [
        { n: "Q3 2026", t: "Fondation", d: "Lancement du $DOFFA sur le mainnet (100M, mint/freeze révoqués), le jeu DOFFA Bean Duel. Le Reward Vault de 1 000 000 $DOFFA est perdu : l’accès au portefeuille est définitivement perdu.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Comment obtenir du $DOFFA ?", a: "Termine des runs DOFFA Bean Duel et appuie sur « Réclamer la récompense » : le $DOFFA du Reward Vault est attaché à ton portefeuille Solana." },
  ...
  de: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Starte einen Run", d: "Bohnen sind dein Eintrittsticket für einen DOFFA-Bean-Duel-Run: Gegnerwellen, Bewegung, Ausweichen und Fähigkeiten." },
      ...
      claimNote: "Run bei DOFFA Bean Duel geschafft? Drücke im Spiel „Belohnung abholen“ — $DOFFA wird als Auszahlungsantrag an Solana deiner Wallet zugeordnet.",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Gründung", d: "$DOFFA-Start auf dem Mainnet (100M, mint/freeze widerrufen), das Spiel DOFFA Bean Duel. Der Reward Vault mit 1.000.000 $DOFFA ist verloren: Der Zugang zur Wallet ist endgültig weg.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Wie bekomme ich $DOFFA?", a: "Schaffe DOFFA-Bean-Duel-Runs und drücke „Belohnung abholen“ — $DOFFA aus dem Reward Vault wird deiner Solana-Wallet zugeordnet." },
  ...
  zh: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "开始闯关", d: "咖啡豆 是进入 DOFFA Bean Duel 闯关的入场券：一波波敌人，走位、闪避与技能。" },
      ...
      claimTitle: "领取奖励",
      claimNote: "在 DOFFA Bean Duel 完成闯关了？在游戏里点「领取奖励」——$DOFFA 将作为向 Solana 的支付申请绑定到你的钱包。",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "如何获得 $DOFFA？", a: "完成 DOFFA Bean Duel 闯关并点击「领取奖励」——Reward Vault 中的 $DOFFA 将绑定到你的 Solana 钱包。" },
  ...
  hi: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "रन शुरू करो", d: "बीन्स DOFFA Bean Duel रन में प्रवेश का टिकट हैं: दुश्मनों की लहरें, मूवमेंट, डॉज और क्षमताएँ।" },
      ...
      claimTitle: "इनाम लें",
      claimNote: "DOFFA Bean Duel का रन पूरा किया? गेम में «इनाम लें» दबाओ — $DOFFA Solana भुगतान-अनुरोध के रूप में तुम्हारे वॉलेट से जुड़ जाता है।",
    ...
    roadmap: {
      ...
      title: "रोडमैप",
      phases: [
        { n: "Q3 2026", t: "नींव", d: "मेननेट पर $DOFFA लॉन्च (100M, mint/freeze निरस्त), DOFFA Bean Duel गेम। 1,000,000 $DOFFA का Reward Vault खो गया: वॉलेट का एक्सेस हमेशा के लिए चला गया।", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "$DOFFA कैसे पाएँ?", a: "DOFFA Bean Duel के रन पूरे करो और «इनाम लें» दबाओ — Reward Vault का $DOFFA तुम्हारे Solana वॉलेट से जुड़ जाता है।" },
  ...
  pt: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Comece um run", d: "Os Grãos são seu ingresso para um run de DOFFA Bean Duel: ondas de inimigos, movimento, esquiva e habilidades." },
      ...
      claimNote: "Completou um run no DOFFA Bean Duel? Toque em «Resgatar recompensa» no jogo — o $DOFFA fica vinculado à sua carteira como pedido de pagamento na Solana.",
    ...
    roadmap: {
      ...
      title: "Roteiro",
      phases: [
        { n: "Q3 2026", t: "Fundação", d: "Lançamento do $DOFFA na mainnet (100M, mint/freeze revogados), o jogo DOFFA Bean Duel. O Reward Vault de 1.000.000 $DOFFA está perdido: o acesso à carteira foi perdido para sempre.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Como consigo $DOFFA?", a: "Complete runs de DOFFA Bean Duel e toque em «Resgatar recompensa» — o $DOFFA do Reward Vault fica vinculado à sua carteira Solana." },
  ...
  it: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Inizia un run", d: "I Chicchi sono il tuo biglietto d’ingresso a un run di DOFFA Bean Duel: ondate di nemici, movimento, schivata e abilità." },
      ...
      claimNote: "Hai completato un run di DOFFA Bean Duel? Premi «Ritira la ricompensa» nel gioco: il $DOFFA viene collegato al tuo wallet come richiesta di pagamento su Solana.",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Fondazione", d: "Lancio di $DOFFA su mainnet (100M, mint/freeze revocati), il gioco DOFFA Bean Duel. Il Reward Vault da 1.000.000 $DOFFA è perduto: l’accesso al portafoglio è andato perso per sempre.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Come ottengo $DOFFA?", a: "Completa i run di DOFFA Bean Duel e premi «Ritira la ricompensa»: il $DOFFA del Reward Vault viene collegato al tuo wallet Solana." },
  ...
  ja: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "ランを始める", d: "ビーンズ は DOFFA Bean Duel のランへの入場チケット。敵のウェーブを移動・回避・スキルで突破します。" },
      ...
      claimTitle: "報酬を受け取る",
      claimNote: "DOFFA Bean Duel のランをクリア？ ゲーム内で「報酬を受け取る」を押すと、$DOFFA が Solana への支払い申請としてウォレットに紐づきます。",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "$DOFFA の入手方法は？", a: "DOFFA Bean Duel のランをクリアし「報酬を受け取る」を押すと、Reward Vault の $DOFFA があなたの Solana ウォレットに紐づきます。" },
