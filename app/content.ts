...
export const dict: Record<Lang, Dict> = {
  ru: {
    ...
    flow: {
      ...
      vaultNote: "Reward Vault — кошелёк, из которого выплачиваются игровые награды. Прежний фонд на 1 000 000 $DOFFA утерян: доступ к его кошельку потерян навсегда. Новый фонд пока не назначен. Все движения видны в блокчейне.",
    ...
    roadmap: {
      ...
      phases: [
        { n: "Q3 2026", t: "Основание", d: "Выпуск $DOFFA на mainnet (100M, mint/freeze отозваны), игра DOFFA Heroes. Фонд наград на 1 000 000 $DOFFA утерян: доступ к кошельку потерян навсегда.", done: true },
  ...
  en: {
    ...
    flow: {
      ...
      vaultNote: "The Reward Vault is the wallet that pays out game rewards. The previous 1,000,000 $DOFFA fund is lost — access to its wallet is gone for good. A new fund has not been designated yet. All movements are visible on-chain.",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Foundation", d: "$DOFFA launch on mainnet (100M, mint/freeze revoked), the DOFFA Heroes game. The 1,000,000 $DOFFA Reward Vault is lost: access to the wallet is gone for good.", done: true },
  ...
  ar: {
    ...
    flow: {
      ...
      vaultNote: "خزينة المكافآت هي المحفظة التي تُدفع منها مكافآت اللعبة. الصندوق السابق البالغ 1,000,000 $DOFFA مفقود: تعذّر الوصول إلى محفظته نهائيًا. لم يُخصَّص صندوق جديد بعد. جميع الحركات مرئية على البلوكشين.",
    ...
    roadmap: {
      ...
      title: "خارطة الطريق",
      phases: [
        { n: "Q3 2026", t: "التأسيس", d: "إطلاق $DOFFA على الشبكة الرئيسية (100M، صلاحيات mint/freeze ملغاة)، لعبة DOFFA Heroes. خزينة المكافآت البالغة 1,000,000 $DOFFA مفقودة: تعذّر الوصول إلى المحفظة نهائيًا.", done: true },
  ...
  tr: {
    ...
    flow: {
      ...
      vaultNote: "Reward Vault, oyun ödüllerinin ödendiği cüzdandır. Önceki 1.000.000 $DOFFA’lık fon kayboldu: cüzdanına erişim kalıcı olarak yitirildi. Yeni bir fon henüz belirlenmedi. Tüm hareketler zincir üstünde görünür.",
    ...
    roadmap: {
      ...
      title: "Yol haritası",
      phases: [
        { n: "Q3 2026", t: "Temel", d: "$DOFFA mainnet çıkışı (100M, mint/freeze iptal), DOFFA Heroes oyunu. 1.000.000 $DOFFA’lık Reward Vault kayboldu: cüzdana erişim kalıcı olarak yitirildi.", done: true },
  ...
  es: {
    ...
    flow: {
      ...
      vaultNote: "El Reward Vault es la cartera desde la que se pagan las recompensas del juego. El fondo anterior de 1.000.000 $DOFFA está perdido: el acceso a su cartera se perdió para siempre. Aún no se ha designado un fondo nuevo. Todos los movimientos son visibles on-chain.",
    ...
    roadmap: {
      ...
      title: "Hoja de ruta",
      phases: [
        { n: "Q3 2026", t: "Fundación", d: "Lanzamiento de $DOFFA en mainnet (100M, mint/freeze revocados), el juego DOFFA Heroes. El Reward Vault de 1.000.000 $DOFFA está perdido: el acceso a la cartera se perdió para siempre.", done: true },
  ...
  fr: {
    ...
    flow: {
      ...
      vaultNote: "Le Reward Vault est le portefeuille depuis lequel sont payées les récompenses du jeu. L’ancien fonds de 1 000 000 $DOFFA est perdu : l’accès à son portefeuille est définitivement perdu. Aucun nouveau fonds n’a encore été désigné. Tous les mouvements sont visibles on-chain.",
    ...
    roadmap: {
      ...
      phases: [
        { n: "Q3 2026", t: "Fondation", d: "Lancement du $DOFFA sur le mainnet (100M, mint/freeze révoqués), le jeu DOFFA Heroes. Le Reward Vault de 1 000 000 $DOFFA est perdu : l’accès au portefeuille est définitivement perdu.", done: true },
  ...
  de: {
    ...
    flow: {
      ...
      vaultNote: "Der Reward Vault ist die Wallet, aus der Spielbelohnungen ausgezahlt werden. Der frühere Fonds von 1.000.000 $DOFFA ist verloren: Der Zugang zu seiner Wallet ist endgültig weg. Ein neuer Fonds wurde noch nicht festgelegt. Alle Bewegungen sind on-chain sichtbar.",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Gründung", d: "$DOFFA-Start auf dem Mainnet (100M, mint/freeze widerrufen), das Spiel DOFFA Heroes. Der Reward Vault mit 1.000.000 $DOFFA ist verloren: Der Zugang zur Wallet ist endgültig weg.", done: true },
  ...
  zh: {
    ...
    flow: {
      ...
      vaultTag: "Reward Vault",
      vaultTitle: "奖励金库",
      vaultNote: "Reward Vault 是支付游戏奖励的钱包。此前 1,000,000 $DOFFA 的资金池已丢失：其钱包的访问权限已永久失去。新的资金池尚未指定。所有变动链上可见。",
    ...
    roadmap: {
      ...
      title: "路线图",
      phases: [
        { n: "Q3 2026", t: "基础", d: "$DOFFA 主网发行（1 亿枚，mint/freeze 已注销）、DOFFA Heroes 游戏、100 万 $DOFFA 的 Reward Vault。", done: true },
  ...
  hi: {
    ...
    flow: {
      ...
      vaultNote: "Reward Vault वह वॉलेट है जिससे गेम इनाम चुकाए जाते हैं। 1,000,000 $DOFFA का पिछला कोष खो गया है: उसके वॉलेट का एक्सेस हमेशा के लिए चला गया। नया कोष अभी तय नहीं हुआ। सभी लेन-देन ऑन-चेन दिखते हैं।",
    ...
    roadmap: {
      ...
      title: "रोडमैप",
      phases: [
        { n: "Q3 2026", t: "नींव", d: "मेननेट पर $DOFFA लॉन्च (100M, mint/freeze निरस्त), DOFFA Heroes गेम। 1,000,000 $DOFFA का Reward Vault खो गया: वॉलेट का एक्सेस हमेशा के लिए चला गया।", done: true },
  ...
  pt: {
    ...
    flow: {
      ...
      vaultNote: "O Reward Vault é a carteira de onde são pagas as recompensas do jogo. O fundo anterior de 1.000.000 $DOFFA está perdido: o acesso à sua carteira foi perdido para sempre. Ainda não foi designado um novo fundo. Todos os movimentos são visíveis on-chain.",
    ...
    roadmap: {
      ...
      title: "Roteiro",
      phases: [
        { n: "Q3 2026", t: "Fundação", d: "Lançamento do $DOFFA na mainnet (100M, mint/freeze revogados), o jogo DOFFA Heroes. O Reward Vault de 1.000.000 $DOFFA está perdido: o acesso à carteira foi perdido para sempre.", done: true },
  ...
  it: {
    ...
    flow: {
      ...
      vaultNote: "Il Reward Vault è il portafoglio da cui vengono pagate le ricompense di gioco. Il fondo precedente da 1.000.000 $DOFFA è perduto: l’accesso al suo portafoglio è andato perso per sempre. Non è ancora stato designato un nuovo fondo. Tutti i movimenti sono visibili on-chain.",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Fondazione", d: "Lancio di $DOFFA su mainnet (100M, mint/freeze revocati), il gioco DOFFA Heroes. Il Reward Vault da 1.000.000 $DOFFA è perduto: l’accesso al portafoglio è andato perso per sempre.", done: true },
  ...
  ja: {
    ...
    flow: {
      ...
      vaultTag: "Reward Vault",
      vaultTitle: "報酬の金庫",
      vaultNote: "Reward Vault はゲーム報酬を支払うウォレットです。以前の 1,000,000 $DOFFA の資金は失われました。ウォレットへのアクセスが永久に失われたためです。新しい資金はまだ指定されていません。すべての動きはオンチェーンで確認できます。",
    ...
    roadmap: {
      ...
      title: "ロードマップ",
      phases: [
        { n: "Q3 2026", t: "基盤", d: "メインネットでの $DOFFA 発行（1億枚、mint/freeze は放棄済み）、DOFFA Heroes、100万 $DOFFA の Reward Vault。", done: true },
