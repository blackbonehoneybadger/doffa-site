...
export const dict: Record<Lang, Dict> = {
  ru: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Входи в забег", d: "Зёрна — входной билет в забег DOFFA Heroes: волны врагов, движение, уклонение и способности." },
        { icon: "🏆", t: "Проходи волны", d: "За подтверждённое прохождение забега — настоящая награда: $DOFFA из ограниченного Reward Vault." },
      ...
      vaultNote: "Reward Vault — кошелёк, из которого выплачиваются игровые награды. Прежний фонд на 1 000 000 $DOFFA ушёл в чёрную дыру проекта: ключ к тому кошельку утерян, и с адреса не уходит ни один токен. Это не сжигание — эмиссия в сети не изменилась. Новый фонд пока не назначен. Все движения видны в блокчейне.",
      vaultAmountLabel: "В хранилище",
      vaultSupplyLabel: "Общий выпуск",
      vaultShareLabel: "Доля эмиссии",
      claimTitle: "Забрать награду",
      claimNote: "Прошёл забег в DOFFA Heroes? Нажми «Забрать награду» в игре — $DOFFA закрепляется за твоим кошельком как заявка на вывод в сеть Solana.",
      playCta: "Играть в DOFFA Heroes",
    ...
    roadmap: {
      ...
      phases: [
        { n: "Q3 2026", t: "Основание", d: "Выпуск $DOFFA на mainnet (100M, mint/freeze отозваны), игра DOFFA Heroes. Фонд наград на 1 000 000 $DOFFA ушёл в чёрную дыру проекта: ключ утерян, токены вне обращения.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Как получить $DOFFA?", a: "Проходи забеги в DOFFA Heroes и нажимай «Забрать награду» — $DOFFA из Reward Vault закрепляется за твоим Solana-кошельком." },
  ...
  en: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Start a run", d: "Beans are your entry ticket to a DOFFA Heroes run — waves of enemies, movement, dodging and abilities." },
        { icon: "🏆", t: "Clear the waves", d: "A verified run earns the real reward — $DOFFA from the limited Reward Vault." },
        { icon: "💰", t: "Claim your reward", d: "The “Claim reward” button pins $DOFFA to your Solana wallet." },
      ],
      vaultTag: "Reward Vault",
      vaultTitle: "The reward vault",
      vaultNote: "The Reward Vault is the wallet that pays out game rewards. The previous 1,000,000 $DOFFA fund went into the project's black hole: the key to that wallet was lost, and nothing ever leaves the address. This is not a burn — on-chain supply is unchanged. A new fund has not been designated yet. All movements are visible on-chain.",
      vaultAmountLabel: "In the vault",
      vaultSupplyLabel: "Total supply",
      vaultShareLabel: "Share of supply",
      claimTitle: "Claim your reward",
      claimNote: "Cleared a DOFFA Heroes run? Hit “Claim reward” in the game — $DOFFA is pinned to your wallet as a payout request to Solana.",
      playCta: "Play DOFFA Heroes",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Foundation", d: "$DOFFA launch on mainnet (100M, mint/freeze revoked), the DOFFA Heroes game. The 1,000,000 $DOFFA reward fund went into the project's black hole: the key was lost, the tokens are out of circulation.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How do I get $DOFFA?", a: "Clear DOFFA Heroes runs and press “Claim reward” — $DOFFA from the Reward Vault is pinned to your Solana wallet." },
  ...
  ar: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "ابدأ الجولة", d: "الحبوب تذكرة دخولك إلى جولة DOFFA Heroes: موجات من الأعداء، حركة، مراوغة ومهارات." },
        { icon: "🏆", t: "اجتز الموجات", d: "الجولة المؤكَّدة تمنح المكافأة الحقيقية — $DOFFA من خزينة المكافآت المحدودة." },
        { icon: "💰", t: "استلم مكافأتك", d: "زر «استلام المكافأة» يثبّت $DOFFA على محفظة سولانا الخاصة بك." },
      ],
      vaultTag: "Reward Vault",
      vaultTitle: "خزينة المكافآت",
      vaultNote: "خزينة المكافآت هي المحفظة التي تُدفع منها مكافآت اللعبة. الصندوق السابق البالغ 1,000,000 $DOFFA ذهب إلى الثقب الأسود للمشروع: مفتاح تلك المحفظة مفقود، ولا يخرج من العنوان أي رمز. هذا ليس حرقًا — المعروض على البلوكشين لم يتغيّر. لم يُخصَّص صندوق جديد بعد. جميع الحركات مرئية على البلوكشين.",
      vaultAmountLabel: "في الخزينة",
      vaultSupplyLabel: "الإصدار الكلي",
      vaultShareLabel: "حصة الإصدار",
      claimTitle: "استلام المكافأة",
      claimNote: "اجتزت جولة DOFFA Heroes؟ اضغط «استلام المكافأة» في اللعبة — يُثبَّت $DOFFA على محفظتك كطلب سحب إلى سولانا.",
      playCta: "العب DOFFA Heroes",
    ...
    roadmap: {
      ...
      title: "خارطة الطريق",
      phases: [
        { n: "Q3 2026", t: "التأسيس", d: "إطلاق $DOFFA على الشبكة الرئيسية (100M، صلاحيات mint/freeze ملغاة)، لعبة DOFFA Heroes. صندوق المكافآت البالغ 1,000,000 $DOFFA ذهب إلى الثقب الأسود للمشروع: المفتاح مفقود والرموز خارج التداول.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "كيف أحصل على $DOFFA؟", a: "اجتز جولات DOFFA Heroes واضغط «استلام المكافأة» — $DOFFA من الخزينة تُثبَّت على محفظتك." },
  ...
  tr: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Koşuya başla", d: "Çekirdek, DOFFA Heroes koşusuna giriş biletidir: düşman dalgaları, hareket, kaçınma ve yetenekler." },
        { icon: "🏆", t: "Dalgaları geç", d: "Onaylanmış koşu gerçek ödülü getirir — sınırlı Reward Vault’tan $DOFFA." },
        { icon: "💰", t: "Ödülünü al", d: "“Ödülü al” düğmesi $DOFFA’yı Solana cüzdanına sabitler." },
      ],
      vaultTag: "Reward Vault",
      vaultTitle: "Ödül kasası",
      vaultNote: "Reward Vault, oyun ödüllerinin ödendiği cüzdandır. Önceki 1.000.000 $DOFFA’lık fon projenin karadeliğine gitti: o cüzdanın anahtarı kayboldu ve adresten hiçbir token çıkmıyor. Bu bir yakma değil — zincir üstündeki arz değişmedi. Yeni bir fon henüz belirlenmedi. Tüm hareketler zincir üstünde görünür.",
      vaultAmountLabel: "Kasada",
      vaultSupplyLabel: "Toplam arz",
      vaultShareLabel: "Arz payı",
      claimTitle: "Ödülünü al",
      claimNote: "DOFFA Heroes koşusunu mu bitirdin? Oyunda “Ödülü al”a bas — $DOFFA, Solana’ya ödeme talebi olarak cüzdanına sabitlenir.",
      playCta: "DOFFA Heroes oyna",
    ...
    roadmap: {
      ...
      title: "Yol haritası",
      phases: [
        { n: "Q3 2026", t: "Temel", d: "$DOFFA mainnet çıkışı (100M, mint/freeze iptal), DOFFA Heroes oyunu. 1.000.000 $DOFFA’lık ödül fonu projenin karadeliğine gitti: anahtar kayboldu, tokenlar dolaşım dışı.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "$DOFFA nasıl alınır?", a: "DOFFA Heroes koşularını tamamla ve “Ödülü al”a bas — Reward Vault’tan $DOFFA cüzdanına sabitlenir." },
  ...
  es: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Empieza un run", d: "Los Granos son tu boleto de entrada a un run de DOFFA Heroes: oleadas de enemigos, movimiento, esquiva y habilidades." },
        { icon: "🏆", t: "Supera las oleadas", d: "Un run verificado otorga la recompensa real: $DOFFA del Reward Vault limitado." },
      ...
      vaultNote: "El Reward Vault es la cartera desde la que se pagan las recompensas del juego. El fondo anterior de 1.000.000 $DOFFA fue al agujero negro del proyecto: la clave de esa cartera se perdió y de esa dirección no sale ningún token. No es una quema: el suministro on-chain no ha cambiado. Aún no se ha designado un fondo nuevo. Todos los movimientos son visibles on-chain.",
      ...
      claimNote: "¿Completaste un run de DOFFA Heroes? Pulsa «Reclamar recompensa» en el juego: $DOFFA se fija a tu billetera como solicitud de pago a Solana.",
      playCta: "Jugar DOFFA Heroes",
    ...
    roadmap: {
      ...
      title: "Hoja de ruta",
      phases: [
        { n: "Q3 2026", t: "Fundación", d: "Lanzamiento de $DOFFA en mainnet (100M, mint/freeze revocados), el juego DOFFA Heroes. El fondo de recompensas de 1.000.000 $DOFFA fue al agujero negro del proyecto: la clave se perdió y los tokens están fuera de circulación.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Cómo consigo $DOFFA?", a: "Completa runs de DOFFA Heroes y pulsa «Reclamar recompensa»: $DOFFA del Reward Vault se fija a tu billetera Solana." },
  ...
  fr: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Lance un run", d: "Les Grains sont ton ticket d’entrée pour un run DOFFA Heroes : vagues d’ennemis, déplacement, esquive et compétences." },
        { icon: "🏆", t: "Franchis les vagues", d: "Un run vérifié rapporte la vraie récompense — du $DOFFA du Reward Vault limité." },
      ...
      vaultNote: "Le Reward Vault est le portefeuille depuis lequel sont payées les récompenses du jeu. L’ancien fonds de 1 000 000 $DOFFA est parti dans le trou noir du projet : la clé de ce portefeuille a été perdue et aucun token ne sort de cette adresse. Ce n’est pas un burn — l’offre on-chain n’a pas changé. Aucun nouveau fonds n’a encore été désigné. Tous les mouvements sont visibles on-chain.",
      ...
      claimNote: "Run DOFFA Heroes terminé ? Appuie sur « Réclamer la récompense » dans le jeu : le $DOFFA est attaché à ton portefeuille comme demande de paiement vers Solana.",
      playCta: "Jouer à DOFFA Heroes",
    ...
    roadmap: {
      ...
      phases: [
        { n: "Q3 2026", t: "Fondation", d: "Lancement du $DOFFA sur le mainnet (100M, mint/freeze révoqués), le jeu DOFFA Heroes. Le fonds de récompenses de 1 000 000 $DOFFA est parti dans le trou noir du projet : la clé a été perdue, les tokens sont hors circulation.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Comment obtenir du $DOFFA ?", a: "Termine des runs DOFFA Heroes et appuie sur « Réclamer la récompense » : le $DOFFA du Reward Vault est attaché à ton portefeuille Solana." },
  ...
  de: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Starte einen Run", d: "Bohnen sind dein Eintrittsticket für einen DOFFA-Heroes-Run: Gegnerwellen, Bewegung, Ausweichen und Fähigkeiten." },
        { icon: "🏆", t: "Wellen überstehen", d: "Ein bestätigter Run bringt die echte Belohnung — $DOFFA aus dem begrenzten Reward Vault." },
      ...
      vaultNote: "Der Reward Vault ist die Wallet, aus der Spielbelohnungen ausgezahlt werden. Der frühere Fonds von 1.000.000 $DOFFA ist im schwarzen Loch des Projekts verschwunden: Der Schlüssel zu jener Wallet ist verloren, und von dieser Adresse geht kein Token ab. Das ist kein Burn — die On-Chain-Menge ist unverändert. Ein neuer Fonds wurde noch nicht festgelegt. Alle Bewegungen sind on-chain sichtbar.",
      vaultAmountLabel: "Im Tresor",
      vaultSupplyLabel: "Gesamtemission",
      vaultShareLabel: "Anteil der Emission",
      claimTitle: "Belohnung abholen",
      claimNote: "Run bei DOFFA Heroes geschafft? Drücke im Spiel „Belohnung abholen“ — $DOFFA wird als Auszahlungsantrag an Solana deiner Wallet zugeordnet.",
      playCta: "DOFFA Heroes spielen",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Gründung", d: "$DOFFA-Start auf dem Mainnet (100M, mint/freeze widerrufen), das Spiel DOFFA Heroes. Der Belohnungsfonds von 1.000.000 $DOFFA ist im schwarzen Loch des Projekts verschwunden: Der Schlüssel ist verloren, die Token sind aus dem Umlauf.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Wie bekomme ich $DOFFA?", a: "Schaffe DOFFA-Heroes-Runs und drücke „Belohnung abholen“ — $DOFFA aus dem Reward Vault wird deiner Solana-Wallet zugeordnet." },
  ...
  zh: {
    ...
    flow: {
      tag: "运作方式",
      title: "Tap → 咖啡豆 → 闯关 → $DOFFA",
      sub: "一条简单诚实、人人可验证的奖励链。",
      steps: [
        { icon: "👆", t: "点击，攒 咖啡豆", d: "在 DOFFA 游戏里点击，赚取 咖啡豆——内部游戏能量。" },
        { icon: "☕", t: "积攒 咖啡豆", d: "咖啡豆 是生态能量。不出售、不是代币——只能靠玩赚取。" },
        { icon: "🏹", t: "开始闯关", d: "咖啡豆 是进入 DOFFA Heroes 闯关的入场券：一波波敌人，走位、闪避与技能。" },
        { icon: "🏆", t: "通关", d: "经确认的闯关带来真正的奖励——来自限量 Reward Vault 的 $DOFFA。" },
        { icon: "💰", t: "领取奖励", d: "点击「领取奖励」，$DOFFA 将绑定到你的 Solana 钱包。" },
      ],
      vaultTag: "Reward Vault",
      vaultTitle: "奖励金库",
      vaultNote: "Reward Vault 是支付游戏奖励的钱包。此前 1,000,000 $DOFFA 的资金池已进入项目的黑洞地址：该钱包的私钥已丢失，任何代币都无法从该地址转出。这不是销毁——链上供应量没有变化。新的资金池尚未指定。所有变动链上可见。",
      vaultAmountLabel: "金库余额",
      vaultSupplyLabel: "总发行量",
      vaultShareLabel: "发行占比",
      claimTitle: "领取奖励",
      claimNote: "在 DOFFA Heroes 完成闯关了？在游戏里点「领取奖励」——$DOFFA 将作为向 Solana 的支付申请绑定到你的钱包。",
      playCta: "玩 DOFFA Heroes",
      downloadCta: "下载游戏",
    },
    verify: {
      tag: "验证",
    ...
    roadmap: {
      ...
      title: "路线图",
      phases: [
        { n: "Q3 2026", t: "基础", d: "$DOFFA 主网发行（1 亿枚，mint/freeze 已注销）、DOFFA Heroes 游戏。100 万 $DOFFA 的奖励资金池已进入项目的黑洞地址：私钥丢失，代币退出流通。", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "如何获得 $DOFFA？", a: "完成 DOFFA Heroes 闯关并点击「领取奖励」——Reward Vault 中的 $DOFFA 将绑定到你的 Solana 钱包。" },
  ...
  hi: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "रन शुरू करो", d: "बीन्स DOFFA Heroes रन में प्रवेश का टिकट हैं: दुश्मनों की लहरें, मूवमेंट, डॉज और क्षमताएँ।" },
        { icon: "🏆", t: "लहरें पार करो", d: "सत्यापित रन असली इनाम देता है — सीमित Reward Vault से $DOFFA।" },
        { icon: "💰", t: "इनाम लो", d: "«इनाम लें» बटन $DOFFA को तुम्हारे Solana वॉलेट से जोड़ देता है।" },
      ],
      vaultTag: "Reward Vault",
      vaultTitle: "इनाम तिजोरी",
      vaultNote: "Reward Vault वह वॉलेट है जिससे गेम इनाम चुकाए जाते हैं। 1,000,000 $DOFFA का पिछला कोष प्रोजेक्ट के ब्लैक होल में चला गया: उस वॉलेट की कुंजी खो गई और उस पते से कोई टोकन बाहर नहीं जाता। यह बर्न नहीं है — ऑन-चेन सप्लाई अपरिवर्तित है। नया कोष अभी तय नहीं हुआ। सभी लेन-देन ऑन-चेन दिखते हैं।",
      vaultAmountLabel: "तिजोरी में",
      vaultSupplyLabel: "कुल आपूर्ति",
      vaultShareLabel: "आपूर्ति का हिस्सा",
      claimTitle: "इनाम लें",
      claimNote: "DOFFA Heroes का रन पूरा किया? गेम में «इनाम लें» दबाओ — $DOFFA Solana भुगतान-अनुरोध के रूप में तुम्हारे वॉलेट से जुड़ जाता है।",
      playCta: "DOFFA Heroes खेलें",
    ...
    roadmap: {
      ...
      title: "रोडमैप",
      phases: [
        { n: "Q3 2026", t: "नींव", d: "मेननेट पर $DOFFA लॉन्च (100M, mint/freeze निरस्त), DOFFA Heroes गेम। 1,000,000 $DOFFA का इनाम कोष प्रोजेक्ट के ब्लैक होल में चला गया: कुंजी खो गई, टोकन प्रचलन से बाहर हैं।", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "$DOFFA कैसे पाएँ?", a: "DOFFA Heroes के रन पूरे करो और «इनाम लें» दबाओ — Reward Vault का $DOFFA तुम्हारे Solana वॉलेट से जुड़ जाता है।" },
  ...
  pt: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Comece um run", d: "Os Grãos são seu ingresso para um run de DOFFA Heroes: ondas de inimigos, movimento, esquiva e habilidades." },
        { icon: "🏆", t: "Supere as ondas", d: "Um run verificado dá a recompensa real — $DOFFA do Reward Vault limitado." },
      ...
      vaultNote: "O Reward Vault é a carteira de onde são pagas as recompensas do jogo. O fundo anterior de 1.000.000 $DOFFA foi para o buraco negro do projeto: a chave dessa carteira foi perdida e nenhum token sai desse endereço. Isto não é uma queima — o supply on-chain não mudou. Ainda não foi designado um novo fundo. Todos os movimentos são visíveis on-chain.",
      vaultAmountLabel: "No cofre",
      vaultSupplyLabel: "Emissão total",
      vaultShareLabel: "Parcela da emissão",
      claimTitle: "Resgate a recompensa",
      claimNote: "Completou um run no DOFFA Heroes? Toque em «Resgatar recompensa» no jogo — o $DOFFA fica vinculado à sua carteira como pedido de pagamento na Solana.",
      playCta: "Jogar DOFFA Heroes",
    ...
    roadmap: {
      ...
      title: "Roteiro",
      phases: [
        { n: "Q3 2026", t: "Fundação", d: "Lançamento do $DOFFA na mainnet (100M, mint/freeze revogados), o jogo DOFFA Heroes. O fundo de recompensas de 1.000.000 $DOFFA foi para o buraco negro do projeto: a chave foi perdida e os tokens estão fora de circulação.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Como consigo $DOFFA?", a: "Complete runs de DOFFA Heroes e toque em «Resgatar recompensa» — o $DOFFA do Reward Vault fica vinculado à sua carteira Solana." },
  ...
  it: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "Inizia un run", d: "I Chicchi sono il tuo biglietto d’ingresso a un run di DOFFA Heroes: ondate di nemici, movimento, schivata e abilità." },
        { icon: "🏆", t: "Supera le ondate", d: "Un run verificato dà la ricompensa vera — $DOFFA dal Reward Vault limitato." },
      ...
      vaultNote: "Il Reward Vault è il portafoglio da cui vengono pagate le ricompense di gioco. Il fondo precedente da 1.000.000 $DOFFA è finito nel buco nero del progetto: la chiave di quel portafoglio è andata perduta e da quell’indirizzo non esce alcun token. Non è un burn: la supply on-chain non è cambiata. Non è ancora stato designato un nuovo fondo. Tutti i movimenti sono visibili on-chain.",
      ...
      claimNote: "Hai completato un run di DOFFA Heroes? Premi «Ritira la ricompensa» nel gioco: il $DOFFA viene collegato al tuo wallet come richiesta di pagamento su Solana.",
      playCta: "Gioca a DOFFA Heroes",
    ...
    roadmap: {
      ...
      title: "Roadmap",
      phases: [
        { n: "Q3 2026", t: "Fondazione", d: "Lancio di $DOFFA su mainnet (100M, mint/freeze revocati), il gioco DOFFA Heroes. Il fondo premi da 1.000.000 $DOFFA è finito nel buco nero del progetto: la chiave è andata perduta, i token sono fuori circolazione.", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Come ottengo $DOFFA?", a: "Completa i run di DOFFA Heroes e premi «Ritira la ricompensa»: il $DOFFA del Reward Vault viene collegato al tuo wallet Solana." },
  ...
  ja: {
    ...
    flow: {
      ...
      steps: [
        ...
        { icon: "🏹", t: "ランを始める", d: "ビーンズ は DOFFA Heroes のランへの入場チケット。敵のウェーブを移動・回避・スキルで突破します。" },
        { icon: "🏆", t: "ウェーブを突破", d: "承認されたランには本物の報酬——限定 Reward Vault からの $DOFFA。" },
        { icon: "💰", t: "報酬を受け取る", d: "「報酬を受け取る」ボタンで $DOFFA が Solana ウォレットに紐づきます。" },
      ],
      vaultTag: "Reward Vault",
      vaultTitle: "報酬の金庫",
      vaultNote: "Reward Vault はゲーム報酬を支払うウォレットです。以前の 1,000,000 $DOFFA の資金はプロジェクトのブラックホールアドレスに入りました。そのウォレットの秘密鍵が失われ、このアドレスからトークンが出ることはありません。これはバーンではなく、オンチェーンの供給量は変わっていません。新しい資金はまだ指定されていません。すべての動きはオンチェーンで確認できます。",
      vaultAmountLabel: "金庫の残高",
      vaultSupplyLabel: "総発行量",
      vaultShareLabel: "発行量に占める割合",
      claimTitle: "報酬を受け取る",
      claimNote: "DOFFA Heroes のランをクリア？ ゲーム内で「報酬を受け取る」を押すと、$DOFFA が Solana への支払い申請としてウォレットに紐づきます。",
      playCta: "DOFFA Heroes で遊ぶ",
    ...
    roadmap: {
      ...
      title: "ロードマップ",
      phases: [
        { n: "Q3 2026", t: "基盤", d: "メインネットでの $DOFFA 発行（1億枚、mint/freeze は放棄済み）、DOFFA Heroes。100万 $DOFFA の報酬資金はプロジェクトのブラックホールアドレスに入りました。鍵は失われ、トークンは流通外です。", done: true },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "$DOFFA の入手方法は？", a: "DOFFA Heroes のランをクリアし「報酬を受け取る」を押すと、Reward Vault の $DOFFA があなたの Solana ウォレットに紐づきます。" },
